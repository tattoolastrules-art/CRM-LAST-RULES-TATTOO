...
export const FLOWS: FlowDef[] = [
  {
    ...
    nodes: [
      ...
      { id: "m2", kind: "message", x: X[4], y: 410, title: "Ubicación / horario", text: "el estudio · Bogotá 📍 Mar–Sáb 11am–8pm. ¿Te muestro portafolio o agendamos? 👑" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "ai1", kind: "ai", x: X[2], y: 350, title: "NOVA · Reactiva", text: "Detecta clientes inactivos y propone nueva tatuaje o retoque en buen momento." },
      { id: "c1", kind: "choice", x: X[3], y: 210, title: "Reactivar", options: ["Quiere otra tatuaje", "Retoque", "Solo gracias"] },
      ...
      { id: "m4", kind: "message", x: X[4], y: 360, title: "Cierre cálido", text: "Gracias por confiar tu piel en LAST RULES 🖤 Aquí estaré para tu próxima tatuaje." },
    ],
    edges: [
      { from: "t", to: "m1" },
      { from: "t", to: "m2" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "m2", kind: "message", x: X[3], y: 150, title: "Dark work", text: "Negros sólidos con presencia 🖤 Mira estas tatuajes." },
      { id: "m3", kind: "message", x: X[3], y: 260, title: "Neo-tribal", text: "Formas orgánicas con fuerza ✨" },
      { id: "m4", kind: "message", x: X[3], y: 370, title: "tatuadores", text: "El Lobo, Aguja Fina, Tinta Negra y Maestra Ámbar — cada uno con su sello 👑" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "m2", kind: "message", x: X[3], y: 190, title: "DM emoji · predefinida", text: "¡Gracias por el 🔥! ¿Quieres ver más tatuajes o agendamos? 👑" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "m2", kind: "message", x: X[4], y: 80, title: "Cover viable", text: "¡Buenas noticias! Se puede transformar en una tatuaje nueva 👑 Agendemos asesoría." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "m1", kind: "message", x: X[2], y: 80, title: "Recomendado", text: "¡Qué honor que te enviaran a el estudio! 🖤 ¿Qué tatuaje imaginas?" },
